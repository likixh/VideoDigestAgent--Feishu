...
CONFIG_SECTIONS = [
    ...
    },
    {
        ...
        "fields": [
            ...
            {
                "key": "YOUTUBE_SEARCH_MAX_TOTAL",
                "label": "Max Total per Cycle",
                "type": "number",
                "default": "15",
                "help": "Cap total search videos processed per cycle (prevents overload)",
            },
            {
                "key": "YOUTUBE_SEARCH_MIN_VIEWS",
                "label": "Min View Count",
                "type": "number",
                "default": "1000",
                "help": "Skip videos with fewer views (0 = no filter)",
            },
        ],
    },
    {
